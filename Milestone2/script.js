  ...
  navigator.geolocation.getCurrentPosition((position) => {
    ...
    fetch(api)
      ...
      .then(function (data) {
        ...
        document.querySelector(".temperature-val").innerHTML =
          data.current.temp_c;
        document.querySelector(".wind-speed-val").innerHTML =
          data.current.wind_kph + " kph";
        document.querySelector(".precipitation-val").innerHTML =
          data.current.precip_in + " in";
        document.querySelector(".temperature-des").innerHTML =
